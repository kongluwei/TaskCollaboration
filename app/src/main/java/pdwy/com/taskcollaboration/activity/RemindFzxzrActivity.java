...
public class RemindFzxzrActivity extends Fragment implements View.OnClickListener{
    TextView tv_cz_0_0;
    TextView tv_cz_0_1;
    TextView tv_cz_1_0;
    TextView tv_cz_1_1;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_remind_fzxzr,null);
        onCreateAfter(view);
        return view;
    }
    protected int getLayoutId() {
        return R.layout.activity_remind_fzxzr;
    }
    ...
    public void onClick(View view) {
            ...
            case R.id.ll_cz_0:
                //新测试任务
                startActivity(new Intent(getActivity(),RemindRwFzxzrActivity.class));
                break;
            case R.id.ll_cz_1:
                //待批准的报告
                startActivity(new Intent(getActivity(),RemindBgFzxzrActivity.class));
                break;
